#!/bin/bash
#SBATCH --job-name=clstm_multi
#SBATCH --output=logs/clstm_multi%j.out
#SBATCH --error=logs/clstm_multi%j.err
...
# Run the notebook
papermill 12_improved_convlstm_global_multitask_run.ipynb output_convlstm_multi.ipynb
